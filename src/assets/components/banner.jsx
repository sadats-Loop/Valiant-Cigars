...
const Banner = () => {
  return (
<section className="bg-[radial-gradient(circle_at_70%_35%,rgba(59,130,246,0.15),transparent_30%),linear-gradient(135deg,#050505_0%,#0B1120_35%,#111827_65%,#050505_100%)]">
 ...
 <div className="relative min-h-162.5 flex items-center overflow-hidden">
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight tracking-tighter text-[#F4F4F5]">
            ONE PUFF
            <br />
...
transition-all duration-700 ease-out transform-gpu hover:scale-[1.05] hover:-translate-y-2">
          ...
          <div className="flex items-center gap-8 text-sm text-zinc-200 pt-6 text-xl">
